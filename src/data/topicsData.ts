...
export const findSubtopicById = (topicId: string, subtopicId: string): Subtopic | undefined => {
  const topic = findTopicById(topicId);
  return topic?.subtopics.find(subtopic => subtopic.id === subtopicId);
};

// Helper function to find concept by ID within a subtopic
export const findConceptById = (topicId: string, subtopicId: string, conceptId: string): Concept | undefined => {
